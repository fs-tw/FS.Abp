...
namespace FS.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See FSMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class FSDbContext : AbpDbContext<FSDbContext>
    {
        public DbSet<AppUser> Users { get; set; }

        /* Add DbSet properties for your Aggregate Roots / Entities here.
         * Also map them inside FSDbContextModelCreatingExtensions.ConfigureFS
         */
