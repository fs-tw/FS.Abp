...
namespace FS.Abp.AspNetCore.Mvc.JsonSubTypes
{
    ...
    public class 交易對象JsonSubtypesConverterBuilders : JsonSubtypesConverterProfile
    {
        public 交易對象JsonSubtypesConverterBuilders()
        {
            this.CreateJsonSubtypesConverter<object>("dis")
                .RegisterSubtype<Object>(1)
                .RegisterSubtype<Object>(2);
            //this.JsonSubtypesConverterOptions.Count()==1
        }
    }
