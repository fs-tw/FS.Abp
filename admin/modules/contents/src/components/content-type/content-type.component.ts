...
> {
  ...
  getList(ContentType: Fs.CmsKitManagement.Contents.Dtos.ContentPropertyGetListDto):
    Observable<PagedResultDto<Fs.CmsKitManagement.Contents.Dtos.ContentPropertyWithDetailsDto>>
  {
