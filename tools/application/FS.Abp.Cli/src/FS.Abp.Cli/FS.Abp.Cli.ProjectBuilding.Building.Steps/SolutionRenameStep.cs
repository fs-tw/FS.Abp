...
namespace FS.Abp.Cli.ProjectBuilding.Building.Steps
{
    public class SolutionRenameStep : ProjectBuildPipelineStep
    {
        ...
        private string projectNamePlaceHolder;
        public SolutionRenameStep(SolutionName solutionName)
        {
            this.companyNamePlaceHolder = solutionName.CompanyName;
            this.projectNamePlaceHolder = solutionName.ProjectName;
        }
