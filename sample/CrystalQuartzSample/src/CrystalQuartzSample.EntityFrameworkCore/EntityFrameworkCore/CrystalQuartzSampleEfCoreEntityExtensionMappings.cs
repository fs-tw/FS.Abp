...
{
    public static class CrystalQuartzSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE CrystalQuartzSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
