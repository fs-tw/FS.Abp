...
export class EntityBlogsApiService {
  ...
  getListByEntityBlog = (EntityBlog: EntityBlogGetListDto) =>
    this.restService.request<any, PagedResultDto<EntityBlogWithDetailsDto>>({
      ...
      params: { entityType: EntityBlog.entityType, entityId: EntityBlog.entityId, skipCount: EntityBlog.skipCount, maxResultCount: EntityBlog.maxResultCount, page: EntityBlog.page, perPage: EntityBlog.perPage, combineWith: EntityBlog.combineWith, sort: EntityBlog.sort, sortBy: EntityBlog.sortBy, sorting: EntityBlog.sorting },
    },
