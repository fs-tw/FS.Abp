...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FS.DynamicForm.Documents.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DynamicFormDocuments");
                });

            modelBuilder.Entity("FS.DynamicForm.Forms.Formal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DynamicFormFormals");
                });

            modelBuilder.Entity("FS.DynamicForm.Forms.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("FormFormalId")
                        .HasColumnName("FormFormalId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FormFormalId");

                    b.HasIndex("ParentId");

                    b.ToTable("DynamicFormGroups");
                });

            modelBuilder.Entity("FS.DynamicForm.Forms.Item", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ItemCodeId")
                        .HasColumnName("ItemCodeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DynamicFormItems");

                    b.HasDiscriminator<int>("Discriminator").HasValue(0);
                });

            modelBuilder.Entity("FS.DynamicForm.Records.Record", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RecordCodeId")
                        .HasColumnName("RecordCodeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.FileItem", b =>
                {
                    b.HasBaseType("FS.DynamicForm.Forms.Item");
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.InputItem", b =>
                {
                    b.HasBaseType("FS.DynamicForm.Forms.Item");

                    b.Property<int>("InputItemType")
                        .HasColumnName("InputItemType")
                        .HasColumnType("int");

                    b.Property<string>("Placeholer")
                        .IsRequired()
                        .HasColumnName("Placeholer")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.SelectItem", b =>
                {
                    b.HasBaseType("FS.DynamicForm.Forms.Item");
                    ...
                    b.Property<int>("SelectItemType")
                        .HasColumnName("SelectItemType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.Group", b =>
                {
                    b.HasOne("FS.DynamicForm.Forms.Formal", "FormFormal")
                        .WithMany("FormGroups")
                        .HasForeignKey("FormFormalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FS.DynamicForm.Forms.Group", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.Item", b =>
                {
                    b.HasOne("FS.DynamicForm.Forms.Group", "FormGroup")
                        .WithMany("FormItems")
            ...
            modelBuilder.Entity("FS.DynamicForm.Records.Record", b =>
                {
                    b.HasOne("FS.DynamicForm.Documents.Document", "FormDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("FS.DynamicForm.Forms.InputItem", b =>
                {
                    b.OwnsOne("FS.DynamicForm.Forms.ItemLimit", "Limit", b1 =>
                        {
                            b1.Property<Guid>("InputItemId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<bool>("IsUse")
                                .HasColumnName("IsUse")
                                .HasColumnType("bit");

                            b1.Property<int>("LowerLimit")
                                .HasColumnName("LowerLimit")
                                .HasColumnType("int");

                            b1.Property<int>("UpperLimit")
                                .HasColumnName("UpperLimit")
                                .HasColumnType("int");

                            b1.HasKey("InputItemId");

                            b1.ToTable("DynamicFormItems");
