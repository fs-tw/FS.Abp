...
import { AccountConfigModule as FS_AccountConfigModule } from '@fs-tw/account/config';
...
// import { CrmNgAlainConfigModule} from '@fs-tw/crm/ng-alain/config';
//import { CmsNgAlainConfigModule} from '@fs-tw/cms/admin/config';
...
@NgModule({
  ...
  imports: [
    ...
    FS_AccountConfigModule.forRoot(),
    ...
    //CmsNgAlainConfigModule.forRoot(),
    NgxsModule.forRoot([]),
