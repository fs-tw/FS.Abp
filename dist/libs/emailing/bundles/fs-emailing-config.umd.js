(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@abp/ng.core'), require('@abp/ng.theme.shared'), require('@angular/core'), require('@fs/emailing/proxy'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@fs/emailing/config', ['exports', '@abp/ng.core', '@abp/ng.theme.shared', '@angular/core', '@fs/emailing/proxy', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.fs = global.fs || {}, global.fs.emailing = global.fs.emailing || {}, global.fs.emailing.config = {}), global.ng_core, global.ng_theme_shared, global.ng.core, global.fs.emailing.proxy, global.rxjs.operators));
...
//# sourceMappingURL=fs-emailing-config.umd.js.map
