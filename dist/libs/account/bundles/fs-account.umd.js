(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@fs/account', ['exports', '@abp/ng.core', '@abp/ng.theme.shared', '@angular/core', '@ng-bootstrap/ng-bootstrap', '@ngx-validate/core', '@angular/router', '@angular/common/http', 'angular-oauth2-oidc', 'rxjs', 'rxjs/operators', 'snq', '@angular/forms', '@ngxs/store', '@angular/animations'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.fs = global.fs || {}, global.fs.account = {}), global.i1, global.ng_theme_shared, global.ng.core, global.ngBootstrap, global.core, global.ng.router, global.ng.common.http, global.i2, global.rxjs, global.rxjs.operators, global.snq, global.ng.forms, global.store, global.ng.animations));
