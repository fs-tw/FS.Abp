(function (global, factory) {
    ...
    var StartupService = /** @class */ (function () {
        ...
        StartupService.prototype.load = function () {
            ...
            return new Promise(function (resolve) {
                rxjs.zip(_this.httpClient.get("assets/tmp/i18n/zh-TW.json"), _this.httpClient.get("assets/tmp/app-data.json"))
                    .pipe(
                // 接收其他拦截器后产生的异常消息
    ...
    */
    ...
    exports.ɵb = RootModule;
    exports.ɵc = GlobalConfigModule;
    exports.ɵd = StartupService;
    exports.ɵe = StartupServiceFactory;
    exports.ɵf = APPINIT_PROVIDES;
    exports.ɵg = LANG;
    exports.ɵh = LANG_PROVIDES;
    exports.ɵi = STYLES_PROVIDERS;
    exports.ɵj = configureStyles;
    exports.ɵk = NGALAINMS_THEME_STYLES_PROVIDERS;
