(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@angular/router'), require('@delon/acl'), require('@delon/form'), require('@delon/theme'), require('@delon/abc/page-header'), require('@delon/abc/se'), require('@delon/abc/st'), require('@delon/abc/sv'), require('@delon/chart/custom'), require('ng-zorro-antd/affix'), require('ng-zorro-antd/alert'), require('ng-zorro-antd/anchor'), require('ng-zorro-antd/avatar'), require('ng-zorro-antd/breadcrumb'), require('ng-zorro-antd/button'), require('ng-zorro-antd/card'), require('ng-zorro-antd/checkbox'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/date-picker'), require('ng-zorro-antd/divider'), require('ng-zorro-antd/drawer'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/form'), require('ng-zorro-antd/grid'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/input'), require('ng-zorro-antd/input-number'), require('ng-zorro-antd/list'), require('ng-zorro-antd/message'), require('ng-zorro-antd/modal'), require('ng-zorro-antd/popconfirm'), require('ng-zorro-antd/popover'), require('ng-zorro-antd/progress'), require('ng-zorro-antd/radio'), require('ng-zorro-antd/select'), require('ng-zorro-antd/skeleton'), require('ng-zorro-antd/spin'), require('ng-zorro-antd/switch'), require('ng-zorro-antd/table'), require('ng-zorro-antd/tabs'), require('ng-zorro-antd/time-picker'), require('ng-zorro-antd/tooltip'), require('ng-zorro-antd/tree'), require('ng-zorro-antd/upload')) :
    typeof define === 'function' && define.amd ? define('@fs-tw/crm/ng-alain/shared', ['exports', '@angular/common', '@angular/core', '@angular/forms', '@angular/router', '@delon/acl', '@delon/form', '@delon/theme', '@delon/abc/page-header', '@delon/abc/se', '@delon/abc/st', '@delon/abc/sv', '@delon/chart/custom', 'ng-zorro-antd/affix', 'ng-zorro-antd/alert', 'ng-zorro-antd/anchor', 'ng-zorro-antd/avatar', 'ng-zorro-antd/breadcrumb', 'ng-zorro-antd/button', 'ng-zorro-antd/card', 'ng-zorro-antd/checkbox', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/date-picker', 'ng-zorro-antd/divider', 'ng-zorro-antd/drawer', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/form', 'ng-zorro-antd/grid', 'ng-zorro-antd/icon', 'ng-zorro-antd/input', 'ng-zorro-antd/input-number', 'ng-zorro-antd/list', 'ng-zorro-antd/message', 'ng-zorro-antd/modal', 'ng-zorro-antd/popconfirm', 'ng-zorro-antd/popover', 'ng-zorro-antd/progress', 'ng-zorro-antd/radio', 'ng-zorro-antd/select', 'ng-zorro-antd/skeleton', 'ng-zorro-antd/spin', 'ng-zorro-antd/switch', 'ng-zorro-antd/table', 'ng-zorro-antd/tabs', 'ng-zorro-antd/time-picker', 'ng-zorro-antd/tooltip', 'ng-zorro-antd/tree', 'ng-zorro-antd/upload'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['fs-tw'] = global['fs-tw'] || {}, global['fs-tw'].crm = global['fs-tw'].crm || {}, global['fs-tw'].crm['ng-alain'] = global['fs-tw'].crm['ng-alain'] || {}, global['fs-tw'].crm['ng-alain'].shared = {}), global.ng.common, global.ng.core, global.ng.forms, global.ng.router, global.acl, global.form$1, global.theme, global.pageHeader, global.se, global.st, global.sv, global.custom, global.affix, global.alert, global.anchor, global.avatar, global.breadcrumb, global.button, global.card, global.checkbox, global.outlet, global.datePicker, global.divider, global.drawer, global.dropdown, global.form, global.grid, global.icon, global.input, global.inputNumber, global.list, global.message, global.modal, global.popconfirm, global.popover, global.progress, global.radio, global.select, global.skeleton, global.spin, global._switch, global.table, global.tabs, global.timePicker, global.tooltip, global.tree, global.upload));
}(this, (function (exports, common, core, forms, router, acl, form$1, theme, pageHeader, se, st, sv, custom, affix, alert, anchor, avatar, breadcrumb, button, card, checkbox, outlet, datePicker, divider, drawer, dropdown, form, grid, icon, input, inputNumber, list, message, modal, popconfirm, popover, progress, radio, select, skeleton, spin, _switch, table, tabs, timePicker, tooltip, tree, upload) { 'use strict';
...
//# sourceMappingURL=fs-tw-crm-ng-alain-shared.umd.js.map
