(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@abp/ng.core'), require('@angular/core'), require('@angular/forms'), require('@angular/router'), require('@delon/theme/layout-default'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/icon'), require('@abp/ng.theme.shared'), require('rxjs/operators'), require('screenfull'), require('@delon/util'), require('snq'), require('@fs-tw/account'), require('@delon/auth'), require('@delon/theme')) :
    typeof define === 'function' && define.amd ? define('@fs-tw/theme-alain/layout', ['exports', '@abp/ng.core', '@angular/core', '@angular/forms', '@angular/router', '@delon/theme/layout-default', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/icon', '@abp/ng.theme.shared', 'rxjs/operators', 'screenfull', '@delon/util', 'snq', '@fs-tw/account', '@delon/auth', '@delon/theme'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['fs-tw'] = global['fs-tw'] || {}, global['fs-tw']['theme-alain'] = global['fs-tw']['theme-alain'] || {}, global['fs-tw']['theme-alain'].layout = {}), global.ng_core, global.ng.core, global.ng.forms, global.ng.router, global.layoutDefault, global.dropdown, global.icon, global.ng_theme_shared, global.rxjs.operators, global.screenfull, global.util, global.snq, global.account, global.auth, global.theme));
...
//# sourceMappingURL=fs-tw-theme-alain-layout.umd.js.map
