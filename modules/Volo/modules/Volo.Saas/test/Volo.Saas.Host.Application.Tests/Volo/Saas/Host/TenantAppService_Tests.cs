...
namespace Volo.Saas.Host
{
    public class TenantAppService_Tests : SaasHostApplicationTestBase
    {
        ...
        public async Task CreateAsync()
        {
            ...
            var tenant = await _tenantAppService.CreateAsync(new SaasTenantCreateDto { Name = tenancyName, AdminEmailAddress = "admin@admin.com", AdminPassword = "123456"});
        ...
        public async Task UpdateAsync()
        {
            ...
            var result = await _tenantAppService.UpdateAsync(acme.Id, new SaasTenantUpdateDto { Name = "acme-renamed" });
