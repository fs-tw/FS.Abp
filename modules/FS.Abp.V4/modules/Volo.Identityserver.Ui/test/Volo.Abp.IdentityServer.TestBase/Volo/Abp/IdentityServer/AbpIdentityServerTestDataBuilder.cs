    ...
    public class AbpIdentityServerTestDataBuilder : ITransientDependency
    {
        ...
        private async Task AddPersistedGrants()
        {
            ...
            await _persistentGrantRepository.InsertAsync(new PersistedGrant(_guidGenerator.Create())
            {
                ...
                ClientId = "c1",
                SessionId = "PersistedGrantSessionId2",
                Type = "c1type",
                Data = ""
            });
            ...
            await _persistentGrantRepository.InsertAsync(new PersistedGrant(_guidGenerator.Create())
            {
                ...
                ClientId = "c1",
                SessionId = "PersistedGrantSessionId3",
                Type = "c1type",
                Data = "",
                Expiration = _clock.Now.AddDays(1),
            });
            ...
            await _persistentGrantRepository.InsertAsync(new PersistedGrant(_guidGenerator.Create())
            {
                ...
                ClientId = "c1",
                SessionId = "PersistedGrantSessionId4",
                Type = "c1type",
                Data = "",
                Expiration = _clock.Now.AddDays(-1)
            });
        ...
        {
            var apiScope = new ApiScope(_testData.ApiScope1Id, "Test-ApiScope-Name-1");
