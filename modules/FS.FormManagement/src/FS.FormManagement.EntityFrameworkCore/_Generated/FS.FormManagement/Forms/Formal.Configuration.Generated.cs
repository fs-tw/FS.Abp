...
{
    public partial class FormalConfiguration : IEntityTypeConfiguration<Formal>
    {
        private FormManagementModelBuilderConfigurationOptions options;
        public FormalConfiguration(FormManagementModelBuilderConfigurationOptions options)
        {
            this.options = options;
        }
        public void Configure(EntityTypeBuilder<Formal> builder)
        {
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<Formal> builder);
