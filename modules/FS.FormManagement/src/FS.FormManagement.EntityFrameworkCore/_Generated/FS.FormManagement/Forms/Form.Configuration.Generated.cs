...
namespace FS.FormManagement.Forms
{
    public partial class FormConfiguration : IEntityTypeConfiguration<Form>
    {
        ...
        public FormConfiguration(FormManagementModelBuilderConfigurationOptions options)
        {
            this.options = options;
        }
        public void Configure(EntityTypeBuilder<Form> builder)
        {
            builder.ToTable(options.TablePrefix + @"Forms", options.Schema);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<Form> builder);
