...
{
    public partial class VersionDefinitionConfiguration : IEntityTypeConfiguration<VersionDefinition>
    {
        private FormManagementModelBuilderConfigurationOptions options;
        public VersionDefinitionConfiguration(FormManagementModelBuilderConfigurationOptions options)
        {
            this.options = options;
        }
        public void Configure(EntityTypeBuilder<VersionDefinition> builder)
        {
            builder.ToTable(options.TablePrefix + @"VersionDefinitions", options.Schema);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<VersionDefinition> builder);
