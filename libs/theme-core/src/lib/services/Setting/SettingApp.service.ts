...
export class SettingAppService {
  ...
  getAvailableSettingsGroups(): Observable<Array<string>> {
    return this.restService.request({ url: '/api/SettingManagement/setting/available-settings-groups', method: 'GET' });
  }
  ...
  getSettingByList(body: Array<SettingInput>): Observable<Array<SettingDefinitionDto>> {
    return this.restService.request({ url: '/api/SettingManagement/setting/get-by-list', method: 'POST', body });
  }
