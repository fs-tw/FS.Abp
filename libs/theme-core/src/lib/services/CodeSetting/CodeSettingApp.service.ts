...
export class CodeSettingAppService {
  ...
  postListBy(body: ListByInput): Observable<ListByOutput> {
    return this.restService.request({ url: '/api/CodingManagement/code-setting/list-by', method: 'POST', body });
  }

  postPatchCodes(body: PatchCodesInput): Observable<void> {
    return this.restService.request({ url: '/api/CodingManagement/code-setting/patch-codes', method: 'POST', body });
  }

  postCreateCodes(body: CreateCodesInput): Observable<void> {
    return this.restService.request({ url: '/api/CodingManagement/code-setting/create-codes', method: 'POST', body });
  }
}
