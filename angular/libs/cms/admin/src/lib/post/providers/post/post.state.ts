...
//         return this.postService.getListWithTagByInput(payload.param).pipe(
//             tap(posts =>
//                 patchState({
//                     posts
//                 })
...
//         return this.postService.deleteByPostPrimaryKey({ id: payload }).pipe(
...
//         return this.postService.createByPostCreate(payload).pipe(
//             switchMap(
...
//         return this.postService.updateByPostPrimaryKeyAndPostUpdate({id}, payload).pipe(
//             switchMap(() => dispatch(new GetPosts(getState().postsPageQueryParam)))
//         );
//     }
