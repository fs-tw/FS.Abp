...
import { ConfigStateService, SessionStateService, RoutesService, LocalizationPipe, InternalStore, EnvironmentService, CoreModule } from '@abp/ng.core';
import snq from 'snq';
...
MSAllNavService.ɵprov = ɵɵdefineInjectable({ factory: function MSAllNavService_Factory() { return new MSAllNavService(ɵɵinject(_HttpClient), ɵɵinject(ArrayService)); }, token: MSAllNavService, providedIn: "root" });
