...
import * as i8 from "@delon/abc/se";
import * as i9 from "ng-zorro-antd/radio";
import * as i10 from "ng-zorro-antd/input";
import * as i11 from "../../image-picker/image-picker.component";
...
CreateComponent.ɵcmp = i0.ɵɵdefineComponent({ type: CreateComponent, selectors: [["fs-create"]], viewQuery: function CreateComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [i2.NgIf, i3.NzModalComponent, i4.NzButtonComponent, i5.NzWaveDirective, i6.ɵNzTransitionPatchDirective, i7.ɵangular_packages_forms_forms_y, i7.NgControlStatusGroup, i7.NgForm, i8.SEContainerComponent, i8.SEComponent, i9.NzRadioGroupComponent, i7.NgControlStatus, i7.NgModel, i9.NzRadioComponent, i7.NumberValueAccessor, i10.NzInputDirective, i7.DefaultValueAccessor, i7.RequiredValidator, i11.ImagePickerComponent], styles: [".uploadImgGrid[_ngcontent-%COMP%]{display:grid;place-items:center;border:1px dashed #ddd;padding:10px;justify-content:center;background-color:#fafafa}"] });
