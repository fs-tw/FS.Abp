...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
var v=function(n,r){return(v=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(n,r){n.__proto__=r}||function(n,r){for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(n[a]=r[a])})(n,r)};Object.create;function y(n,r){var a="function"==typeof Symbol&&n[Symbol.iterator];if(!a)return n;var e,i,l=a.call(n),s=[];try{for(;(void 0===r||r-- >0)&&!(e=l.next()).done;)s.push(e.value)}catch(n){i={error:n}}finally{try{e&&!e.done&&(a=l.return)&&a.call(l)}finally{if(i)throw i.error}}return s}function x(){for(var n=[],r=0;r<arguments.length;r++)n=n.concat(y(arguments[r]));return n}Object.create;var w=function(n){function r(){return null!==n&&n.apply(this,arguments)||this}return function(n,r){if("function"!=typeof r&&null!==r)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");function a(){this.constructor=n}v(n,r),n.prototype=null===r?Object.create(r):(a.prototype=r.prototype,new a)}(r,n),Object.defineProperty(r.prototype,"abpErrors",{get:function(){return this.errors&&this.errors.length?this.errors.map((function(n){if(!n.message)return n;var r=n.message.indexOf("[");return r>-1?Object.assign(Object.assign({},n),{message:n.message.slice(0,r),interpoliteParams:n.message.slice(r+1,n.message.length-1).split(",")}):n})):[]},enumerable:!1,configurable:!0}),r}(o.ValidationErrorComponent);w.decorators=[{type:r.Component,args:[{selector:"abp-validation-error",template:'\n    <span\n      class="field-validation-error text-danger"\n      data-valmsg-for="Role.Name"\n      data-valmsg-replace="true"\n      ><span *ngFor="let error of abpErrors; trackBy: trackByFn">\n        {{ error.message | abpLocalization: error.interpoliteParams }}</span\n      ></span\n    >\n  ',changeDetection:r.ChangeDetectionStrategy.OnPush,encapsulation:r.ViewEncapsulation.None,styles:["\n      .custom-checkbox + * .field-validation-error span,\n      ngb-timepicker + * .field-validation-error span {\n        background: transparent !important;\n        border: 0 !important;\n        color: currentColor !important;\n        padding: 0 !important;\n      }\n    "]}]}];var k=[{provide:r.APP_INITIALIZER,useFactory:C,deps:[r.Injector],multi:!0}];function C(n){return function(){!function(n,r){n.events.pipe(t.filter((function(n){return n instanceof l.NavigationEnd})),t.delay(0)).subscribe((function(n){console.log("angular-ready"),r.AppComponent.nativeElement.dispatchEvent(new CustomEvent("angular-ready"))}))}(n.get(l.Router),n.get(f))}}var S=[{provide:r.APP_INITIALIZER,useFactory:_,deps:[r.Injector],multi:!0}];function _(n){return function(){var r=n.get(a.ReplaceableComponentsService);n.get(f);n.get(a.ConfigStateService).createOnUpdateStream((function(n){return n})).subscribe((function(){})),function(n){n.add({key:"Theme.ApplicationLayoutComponent",component:d}),n.add({key:"Theme.AccountLayoutComponent",component:d}),n.add({key:"Theme.EmptyLayoutComponent",component:d})}(r)}}var E=[{provide:r.APP_INITIALIZER,useFactory:L,deps:[a.SettingTabsService],multi:!0}];function L(n){return function(){n.add([{name:"UnifyThemeManagement::Menu:UnifyThemeSettings",order:2,component:b}])}}var P=[d,m,p],M=function(){function n(){}return n.forRoot=function(){return{ngModule:A,providers:[S,k,E]}},n}();M.decorators=[{type:r.NgModule,args:[{declarations:x(P,[u,g,h,w,b]),exports:x(P,[u,g,b]),entryComponents:x(P),imports:[a.CoreModule,e.ThemeSharedModule,c.NgbDropdownModule,o.NgxValidateCoreModule]}]}];var A=function(){};A.decorators=[{type:r.NgModule,args:[{imports:[o.NgxValidateCoreModule.forRoot({targetSelector:".form-control",invalidClasses:"input-validation-error",blueprints:{creditCard:"AbpValidation::ThisFieldIsNotAValidCreditCardNumber.",email:"AbpValidation::ThisFieldIsNotAValidEmailAddress.",invalid:"AbpValidation::ThisFieldIsNotValid.",max:"AbpValidation::ThisFieldMustBeBetween{0}And{1}[{{ min }},{{ max }}]",maxlength:"AbpValidation::ThisFieldMustBeAStringOrArrayTypeWithAMaximumLengthOf{0}[{{ requiredLength }}]",min:"AbpValidation::ThisFieldMustBeBetween{0}And{1}[{{ min }},{{ max }}]",minlength:"AbpValidation::ThisFieldMustBeAStringOrArrayTypeWithAMinimumLengthOf{0}[{{ requiredLength }}]",ngbDate:"AbpValidation::ThisFieldIsNotValid.",passwordMismatch:"AbpIdentity::Volo.Abp.Identity:PasswordConfirmationFailed",range:"AbpValidation::ThisFieldMustBeBetween{0}And{1}[{{ min }},{{ max }}]",required:"AbpValidation::ThisFieldIsRequired.",url:"AbpValidation::ThisFieldIsNotAValidFullyQualifiedHttpHttpsOrFtpUrl"},errorTemplate:w})]}]}],n.AccountLayoutComponent=m,n.ApplicationLayoutComponent=d,n.BannerComponent=h,n.EmptyLayoutComponent=p,n.FooterComponent=g,n.HeaderComponent=u,n.LAYOUTS=P,n.LayoutStateService=f,n.RootUnifyModule=A,n.SettingsComponent=b,n.ThemeUnifyModule=M,n.UNIFY_THEME_INITIAL_PROVIDERS=k,n.UNIFY_THEME_STYLES_PROVIDERS=S,n.ValidationErrorComponent=w,n.configureInitial=C,n.configureStyles=_,n.ɵa=E,n.ɵb=L,Object.defineProperty(n,"__esModule",{value:!0})}));
//# sourceMappingURL=fs-tw-theme-unify.umd.min.js.map