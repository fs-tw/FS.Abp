...
namespace FS.LineNotify.EntityFrameworkCore
{
    public static class LineNotifyDbContextModelCreatingExtensions
    {
        public static void ConfigureLineNotify(
            ...
            Action<LineNotifyModelBuilderConfigurationOptions> optionsAction = null)
        {
            Check.NotNull(builder, nameof(builder));

            var options = new LineNotifyModelBuilderConfigurationOptions(
                LineNotifyDbProperties.DbTablePrefix,
                LineNotifyDbProperties.DbSchema
            );
